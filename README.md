...
**Актуальное техническое задание:** [docs/TZ-v2.md](docs/TZ-v2.md) (версия 2, реалистичный MVP). Документ «Окончательное ТЗ» в `docs/` — архив, не отражает текущий объём продукта.
